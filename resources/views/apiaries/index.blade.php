        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse ($apiaries as $apiary)
                    <div class="block bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out dark:bg-dark-surface dark:hover:bg-gray-700">
                        <div class="p-6 flex">
                            <div class="mr-4 flex-shrink-0">
                                {!! QrCode::size(80)->generate(route('apiaries.show', $apiary)) !!}
                            </div>
                            <div class="flex-grow">
                                <a href="{{ route('apiaries.show', $apiary) }}" class="block">
