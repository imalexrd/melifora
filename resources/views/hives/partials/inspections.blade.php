<div id="inspections-content" class="tab-content">
    ...
    <div class="mb-6 bg-white rounded-lg shadow-md p-6 dark:bg-dark-surface">
        <h4 class="text-xl font-semibold mb-4 dark:text-dark-text-dark">Añadir Nueva Inspección</h4>
        <form action="{{ route('hives.inspections.store', $hive) }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Inspection Date -->
                <div>
                    <label for="inspection_date" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                    ...
                    <x-text-input id="inspection_date" class="block mt-1 w-full dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600" type="date" name="inspection_date" :value="old('inspection_date', now()->format('Y-m-d'))" required />
                    <x-input-error :messages="$errors->get('inspection_date')" class="mt-2" />
                </div>

                <!-- Queen Status -->
                <div>
                    <label for="queen_status" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                    ...
                    <select id="queen_status" name="queen_status" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600">
                ...
                <!-- Population -->
                <div>
                    <label for="population" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                ...
                <!-- Honey Stores -->
                <div>
                    <label for="honey_stores" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                ...
                <!-- Pollen Stores -->
                <div>
                    <label for="pollen_stores" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                ...
                <!-- Brood Pattern -->
                <div>
                    <label for="brood_pattern" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                ...
                <!-- Behavior -->
                <div>
                    <label for="behavior" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                ...
                <!-- Pests and Diseases -->
                <div>
                     <label for="pests_diseases" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                    ...
                    <select id="pests_diseases" name="pests_diseases" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600">
                ...
                <!-- Treatments -->
                <div>
                    <label for="treatments" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                    ...
                    <select id="treatments" name="treatments" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600">
                ...
                <!-- Anomalies -->
                <div>
                    <label for="anomalies" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                        {{ __('Anomalías') }}
                    </label>
                    <select id="anomalies" name="anomalies" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600">
                ...
                <!-- Social States -->
                <div>
                    <label for="social_states" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                        {{ __('Estados Sociales') }}
                    </label>
                    <select id="social_states" name="social_states" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600">
                ...
                <!-- Season States -->
                <div>
                    <label for="season_states" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                        {{ __('Estados de Estación') }}
                    </label>
                    <select id="season_states" name="season_states" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600">
                ...
                <!-- Admin States -->
                <div>
                    <label for="admin_states" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                        {{ __('Estados de Administración') }}
                    </label>
                    <select id="admin_states" name="admin_states" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600">
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    <label for="notes" class="flex items-center text-sm font-medium text-gray-700 dark:text-dark-text-light">
                        <svg class="h-5 w-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                        {{ __('Notas Adicionales') }}
                    </label>
                    <textarea id="notes" name="notes" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:bg-dark-surface dark:text-dark-text-dark dark:border-gray-600">{{ old('notes', $lastInspection->notes ?? '') }}</textarea>
    ...
    <!-- Inspections History -->
    <div class="mt-8">
        <h4 class="text-xl font-semibold mb-4 dark:text-dark-text-dark">Historial de Inspecciones</h4>
        <div class="space-y-6">
            @forelse ($hive->inspections as $inspection)
                <div class="bg-gray-50 rounded-lg shadow-md p-6 border border-gray-200 dark:bg-dark-surface dark:border-gray-700">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="font-semibold text-lg text-gray-800 dark:text-dark-text-dark">{{ $inspection->inspection_date->format('d/m/Y') }}</p>
                            <p class="text-sm text-gray-500 dark:text-dark-text-light">Inspección #{{ $inspection->id }}</p>
                        </div>
                        <div class="flex items-center space-x-2">
                             @if ($inspection->queen_status === 'Presente' || $inspection->queen_status === 'Reina Fecundada')
                                <span class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">Reina OK</span>
                            @else
                                <span class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-yellow-900 dark:text-yellow-300">{{ $inspection->queen_status }}</span>
                            @endif
                            @if ($inspection->pests_diseases !== 'Sin plagas')
                                <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">Alerta Plaga</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="mt-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-dark-text-light">Población</p>
                                <p class="text-lg font-semibold text-gray-800 dark:text-dark-text-dark">{{ $inspection->population }}%</p>
                            </div>
                        </div>
                        <!-- Honey -->
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-dark-text-light">Miel</p>
                                <p class="text-lg font-semibold text-gray-800 dark:text-dark-text-dark">{{ $inspection->honey_stores }}%</p>
                            </div>
                        </div>
                        <!-- Pollen -->
                         <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-dark-text-light">Polen</p>
                                <p class="text-lg font-semibold text-gray-800 dark:text-dark-text-dark">{{ $inspection->pollen_stores }}%</p>
                            </div>
                        </div>
                        <!-- Brood -->
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-dark-text-light">Cría</p>
                                <p class="text-lg font-semibold text-gray-800 dark:text-dark-text-dark">{{ $inspection->brood_pattern }}%</p>
                            </div>
                        </div>
                        <!-- Behavior -->
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-dark-text-light">Agresividad</p>
                                <p class="text-lg font-semibold text-gray-800 dark:text-dark-text-dark">{{ $inspection->behavior }}%</p>
                            </div>
                        </div>
                        <!-- Pests -->
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-dark-text-light">Plagas</p>
                                <p class="text-lg font-semibold text-gray-800 dark:text-dark-text-dark">{{ $inspection->pests_diseases }}</p>
                            </div>
                        </div>
                         <!-- Treatments -->
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-dark-text-light">Tratamientos</p>
                                <p class="text-lg font-semibold text-gray-800 dark:text-dark-text-dark">{{ $inspection->treatments }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    @if($inspection->notes)
                        <div class="mt-6 border-t border-gray-200 pt-4 dark:border-gray-700">
                            <h5 class="text-md font-semibold text-gray-700 dark:text-dark-text-dark">Notas Adicionales</h5>
                            <p class="mt-2 text-sm text-gray-600 dark:text-dark-text-light">{{ $inspection->notes }}</p>
                        </div>
                    @endif
                </div>
            @empty
                <div class="text-center py-12">
                    <p class="text-gray-500 text-lg dark:text-dark-text-light">No hay inspecciones registradas para esta colmena.</p>
                </div>
            @endforelse
        </div>
    </div>
