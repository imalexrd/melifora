        ...
        <form action="{{ route('hives.inspections.store', $hive) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="range" id="population" name="population" min="0" max="100" value="{{ old('population', $lastInspection->population ?? 50) }}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                    <span id="population_value" class="text-sm text-gray-600">{{ old('population', $lastInspection->population ?? 50) }}</span>
                ...
                <div>
                    ...
                    <input type="range" id="honey_stores" name="honey_stores" min="0" max="100" value="{{ old('honey_stores', $lastInspection->honey_stores ?? 50) }}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                    <span id="honey_stores_value" class="text-sm text-gray-600">{{ old('honey_stores', $lastInspection->honey_stores ?? 50) }}</span>
                ...
                <div>
                    ...
                    <input type="range" id="pollen_stores" name="pollen_stores" min="0" max="100" value="{{ old('pollen_stores', $lastInspection->pollen_stores ?? 50) }}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                    <span id="pollen_stores_value" class="text-sm text-gray-600">{{ old('pollen_stores', $lastInspection->pollen_stores ?? 50) }}</span>
                ...
                <div>
                    ...
                    <input type="range" id="brood_pattern" name="brood_pattern" min="0" max="100" value="{{ old('brood_pattern', $lastInspection->brood_pattern ?? 50) }}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                    <span id="brood_pattern_value" class="text-sm text-gray-600">{{ old('brood_pattern', $lastInspection->brood_pattern ?? 50) }}</span>
                ...
                <div>
                    ...
                    <input type="range" id="behavior" name="behavior" min="0" max="100" value="{{ old('behavior', $lastInspection->behavior ?? 50) }}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                    <span id="behavior_value" class="text-sm text-gray-600">{{ old('behavior', $lastInspection->behavior ?? 50) }}</span>
